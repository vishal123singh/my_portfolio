...
const CubeSceneMini = dynamic(() => import('@/app/components/ProjectPreviewComponents/CubeSceneMini'), {
    ssr: false,
    loading: () => <div className="h-[250px] w-full bg-gray-900 animate-pulse rounded-t-xl" />,
});
const ProductDemoMini = dynamic(() => import('@/app/components/ProjectPreviewComponents/ProductDemoMini'), { ssr: false });
const ScrollStoryMini = dynamic(() => import('@/app/components/ProjectPreviewComponents/ScrollStoryMini'), { ssr: false });
...
const uiExperiments = [
    ...
    },
    {
        ...
        image: "/images/3d-viewer-demo.gif",
        link: "/playground/product-demo",
        tags: ["Three.js", "React Three Fiber", "GSAP"],
        liveComponent: <ProductDemoMini />,
    },
     {
